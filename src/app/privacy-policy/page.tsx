...
const PrivacyPolicy = () => {
  return (
    <div>
      <Head>
        <title>Privacy Policy - ADRIG AI Technologies</title>
        <meta
          name="description"
          content="Privacy Policy for ADRIG AI Technologies Private Limited"
        />
      </Head>
      <div className="max-w-3xl mx-auto p-6 sm:p-8 bg-white ">
        ...
        <ul className="list-disc list-inside text-gray-800 space-y-3">
          <li>
            ...
            <a
              href="http://www.adrig.co.in"
              className="text-blue-600 hover:underline"
            >
              http://www.adrig.co.in
            </a>
            , or any website of ours that links to this Privacy Notice.
          </li>
          <li>
            Download and use our mobile application, our Facebook application
            (Test App), or any other application of ours that links to this
            Privacy Notice.
          </li>
          <li>
      ...
      <div className="max-w-3xl mx-auto p-6 sm:p-8 bg-white ">
        ...
        <p className="text-gray-700">
          ...
          <a href="#toc" className="text-blue-600 underline">
            <strong>
      ...
      <div className="max-w-3xl mx-auto p-6 sm:p-8 bg-white ">
        ...
        <ul className="space-y-4 text-lg sm:text-xl text-blue-600">
          <li>
      ...
      <div className="max-w-3xl mx-auto p-6 sm:p-8 bg-white text-base text-gray-700 leading-relaxed">
        <p>
          ...
          <span className="font-medium text-blue-600">Stripe</span> and
          <span className="font-medium text-blue-600">Razorpay</span>. You may
        ...
        <p className="mt-4">
          ...
          the section called
          <a href="#sociallogins" className="text-blue-600">
            {" "}
      ...
      <div className="max-w-3xl mx-auto p-6 sm:p-8 bg-white">
        <div className="text-sm text-gray-600 leading-relaxed">
          <div className="mb-4">
            <strong className="block font-semibold">Application Data</strong>
            <p className="mt-2">
          ...
          <ul className="list-inside list-disc pl-5 mt-2">
            <li>
              ...
              service provider and/or mobile carrier, and Internet Protocol (IP)
              address (or proxy server). If you are using our application(s), we
      ...
      <div className="max-w-3xl mx-auto p-6 sm:p-8 bg-white ">
        <div className="space-y-4">
          <h3 className="text-xl font-bold text-black">Google API</h3>
      ...
      <div className="max-w-3xl mx-auto p-6 sm:p-8 bg-white ">
        ...
        <ul className="list-disc pl-6 mb-4">
          <li className="text-base mb-2">
            ...
            <a href="#withdrawconsent" className="text-blue-500 underline">
...
// max-w-3xl mx-auto p-6 sm:p-8 bg-white
