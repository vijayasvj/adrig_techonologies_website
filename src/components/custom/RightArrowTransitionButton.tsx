...
const RightArrowTransitionButton = ({ buttonText, navigateTo }: Props) => {
  return (
    <Link
      ...
      className="w-fit"
    >
      <Button className="w-fit rounded-none bg-blue-700 hover:bg-blue-800 text-white px-4 py-2 font-normal group text-sm sm:text-md lg:text-lg flex items-center">
